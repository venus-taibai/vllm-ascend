...
class AscendOmniInferSchedulerV1(Scheduler):
    def __init__(
        self,
        vllm_config: VllmConfig,
        kv_cache_config: KVCacheConfig,
    ...
    def schedule(self) -> SchedulerOutput:
        ...
        is_spec_decode_kv_consumer = self.vllm_config.speculative_config is not None and \
                                        self.vllm_config.kv_transfer_config is not None \
                                        and self.vllm_config.kv_transfer_config.is_kv_consumer
        scheduled_new_reqs: list[Request] = []
        scheduled_resumed_reqs: list[Request] = []
    ...
    def add_request(self, request: Request) -> None:
        if self.is_deepseek_mtp_kv_consumer:
            ...
            request.spec_token_ids = [PLACEHOLDER_TOKEN_ID] * num_speculative_tokens
