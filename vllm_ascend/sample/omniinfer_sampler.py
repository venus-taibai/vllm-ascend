...
from vllm.sequence import VLLM_INVALID_TOKEN_ID, Logprob
from vllm.v1.outputs import LogprobsTensors
from vllm.v1.outputs import SamplerOutput as SamplerOutputV1
from vllm.v1.sample.ops.topk_topp_sampler import \
    TopKTopPSampler as TopKTopPSampler
...
def _sample(
    ...
    * Defer Pythonization & preserve GPU-side
    ...
    for sampling_type in SamplingType:
        ...
        elif False: #sampling_type == SamplingType.BEAM:
...
class AscendSampler(Sampler):
    ...
    def _init_sampling_tensors(
        ...
        self._do_temperature = True
        self._do_penalties = do_penalties
        self._do_repetition_penalties = True
        self._do_presence_penalties = True
        self._do_frequency_penalties = True
...
class SimpleSampler(RejectionSamplerV1):
    ...
    def forward(self, input_ids, logits, logits_indices, sampling_metadata, num_decodes, num_prefills, bonus_token_ids, target_logits, metadata):
        ...
        if self.main_sampler is None or sampling_metadata.all_greedy:
            ...
            if sampling_metadata.allowed_token_ids_mask is None \
                ...
                sampling_metadata.temperature = sampling_metadata.temperature.repeat_interleave(num_sampling_tokens_per_req)
