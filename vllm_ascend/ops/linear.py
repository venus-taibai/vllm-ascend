...
class CustomColumnParallelLinear(ColumnParallelLinear):
    """Support custom communication group and the linear layer with column parallelism.
    ...
    Args:
        ...
        custom_tp_group: custom communication parallel group
    ...
    def __init__(
        ...
        *,
        ...
        self.comm_group = custom_tp_group
        self.tp_size = custom_tp_group.world_size
        self.tp_rank = custom_tp_group.rank_in_group
...
class CustomMergedColumnParallelLinear(CustomColumnParallelLinear):
    ...
    def __init__(
        ...
        *,
        ...
        tp_size = custom_tp_group.world_size
...
class CustomSharedExpertDownProj(CustomRowParallelLinear):
    pass
...
class OprojCustomRowParallelLinear(CustomRowParallelLinear):
    ...
    def forward(
        ...
        dist.all_to_all_single(
            recv_buf, send_buf, group=self.comm_group.device_group)
