...
class NPUWorker(WorkerBase):
    ...
    def determine_available_memory(self) -> int:
        ...
        available_kv_cache_memory = int(
            ...
            peak_memory)
        npu_kv_cache_bytes = int(max(available_kv_cache_memory, 0))
        logger.info(
