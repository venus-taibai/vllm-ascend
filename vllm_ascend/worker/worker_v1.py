...
from vllm_ascend.utils import (init_ascend_soc_version, is_enable_nz,
                               ...
                               try_register_lib, enable_sp)

from vllm_ascend.worker.reinference.common import FaultToleranceLevel
from vllm_ascend.worker.reinference.fault_tolerance import FaultTolerance
...
class NPUWorker(WorkerBase):
    ...
    def load_model(self) -> None:
        ...
        with context:
            ...
            # support token re-inference
            if envs_ascend.VLLM_ASCEND_TOKEN_RE_INFERENCE:
