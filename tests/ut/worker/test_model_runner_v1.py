...
@pytest.mark.parametrize(
    ...
    [
        ...
        (AscendSocVersion.A2, False, 8, 2, 100, 256, None, MoECommType.ALLGATHER),
        (AscendSocVersion.A3, False, 16, 2, 500, 256, None, MoECommType.ALLGATHER),

        # Case 2: A2 SOC with w4a8_dynamic -> use alltoall when not mc2
        (AscendSocVersion.A2, True, 8, 1, 100, 256, "w4a8_dynamic", MoECommType.ALLTOALL),
        (AscendSocVersion.A2, True, 16,1, 257, 256, "w4a8_dynamic", MoECommType.ALLTOALL),
        (AscendSocVersion.A2, True, 16, 1, 100, 256, "w4a8_dynamic", MoECommType.MC2),  # meets mc2 condition
